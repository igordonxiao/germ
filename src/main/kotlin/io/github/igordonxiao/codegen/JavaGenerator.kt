 ...
 */
@Api(value = "${DOMAIN}/${firstLowerCamelTableName}s", description = "")
@RestController
@RequestMapping("${DOMAIN}/${firstLowerCamelTableName}s")
public class ${camelTableName}Controller {
    ...
    public ${camelTableName} add(@ApiParam(value = "${firstLowerCamelTableName}", type = "${camelTableName}") @RequestBody ${camelTableName} ${firstLowerCamelTableName}) {
...
@Controller
@RequestMapping("${DOMAIN}/healthCheck")
